...
public class chartview extends View {
     ...
     * x轴集合
     */
    private float mXAxis[] = new float[5];

    /**
     * 白天y轴集合
     */
    private float mYAxisDay[] = new float[5];

    /**
     * 夜间y轴集合
     */
    private float mYAxisNight[] = new float[5];
     ...
     * 白天温度集合
     */
    private int mTempDay[] = new int[5];

    /**
     * 夜间温度集合
     */
    private int mTempNight[] = new int[5];
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (currentNightMode == Configuration.UI_MODE_NIGHT_YES) {
            // Night mode, set white color
            float densityText = getResources().getDisplayMetrics().scaledDensity;
             textColor= Color.WHITE;
            mColorDay=Color.WHITE;
            mColorNight=Color.WHITE;
            mTextSize=14* densityText;
        } else {
            // Day mode, set black color
            float densityText = getResources().getDisplayMetrics().scaledDensity;
             textColor=Color.BLACK;
            mColorDay=Color.BLACK;
            mColorNight=Color.BLACK;
            mTextSize=14* densityText;
        }
